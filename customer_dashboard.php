...
<head>
    ...
    <title>Customer Dashboard - Lady M</title>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="./#menu">
                    ...
                    <span>Order Foods</span></a>
            </li>
            <!-- Nav Item - Manage Submissions-->
            <!-- <li class="nav-item">
                <a class="nav-link" href="view_orders.php">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Orders Status</span></a>
            </li>  -->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">FOODS</div>
                                                </div>
                                                <!-- <div class="col"> -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                               BOOK </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">A TABLE</div>
                                        </div></a>
